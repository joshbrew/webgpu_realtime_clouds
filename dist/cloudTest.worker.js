  ...
  var CloudComputeBuilder = class {
    ...
    _initCompute() {
      ...
      if (!deviceCache.module) {
        deviceCache.module = d.createShaderModule({ code: clouds_default });
      }
    ...
    `;
      ...
      this._historyCopy = { ...deviceCache.historyCopy, bgCache: /* @__PURE__ */ new Map() };
      this._historyCopyBgCache.clear();
      this._historyCopyBgKeys.length = 0;
      return this._historyCopy;
    }
...
`;
  ...
  function renderUniformSignature(preview, aspect, layerIndex, cloudParams = {}, outputWidth = MAIN_W, outputHeight = MAIN_H) {
    return JSON.stringify({
      ...
      alphaFloor: signatureScalar(preview?.alphaFloor ?? 0),
  ...
  async function runFrame({
    ...
    const encodedDispatch = typeof cb.encodeDispatchPasses === "function" ? cb.encodeDispatchPasses(enc, { coarseFactor: cf, reconstructAtPresentation }) : null;
    if (!encodedDispatch) {
